(function ($) {
  ...
  ScratchPad.prototype = {
    _generate: function () {
      ...
      // this.$img = $('<img src=""/>').attr('crossOrigin', 'use-credentials').css({position: 'absolute', width: '100%', height: '100%'});
      this.$img = $('<img src=""/ id="test123">').css({ position: 'absolute', width: '100%', height: '100%' });
